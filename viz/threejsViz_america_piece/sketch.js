...
const current_movie = "Captain America";
const path_to_file = "captain_america_3d_vector_result.json";
...
function init() {
    ...
    var textColor = 0x00fff6;
    var textOutlineColor = 0x6600ff;
    var bgColor = 0x2200cc;
    ...
    word1Pos.x = Math.floor(mapping(word1Pos.x, -17., 18., -500., 500.));
    word1Pos.y = Math.floor(mapping(word1Pos.y, -17., 18., -500., 500.));
    word1Pos.z = Math.floor(mapping(word1Pos.z, -17., 18., -400., 500.));

    word2Pos.x = data[word2][0];
    word2Pos.y = data[word2][1];
    word2Pos.z = data[word2][2];
    word2Pos.x = Math.floor(mapping(word2Pos.x, -17., 18., -500., 500.));
    word2Pos.y = Math.floor(mapping(word2Pos.y, -17., 18., -500., 500.));
    word2Pos.z = Math.floor(mapping(word2Pos.z, -17., 18., -400., 500.));
    // Calculate the distance between this two words
    var _diff = diff(word1Pos.x, word1Pos.y, word1Pos.z, word2Pos.x, word2Pos.y, word2Pos.z);
